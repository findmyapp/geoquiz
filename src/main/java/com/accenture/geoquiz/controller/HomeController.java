...
public class HomeController {
	 ...
	 * List of all events
	 */
	@RequestMapping(value="/backend/events", method=RequestMethod.GET)
	public ModelAndView getEvents() {
		logger.info("List all events");
		List<Event> events = service.getEvents();
		return new ModelAndView("home", "events", gson.toJson(events));
	}
	/**
	...
	public ModelAndView getEvent(
		...
		return new ModelAndView("home", "events", gson.toJson(event));
	}
	/**
